...
<button class="bg-[#5F5F5F] text-white font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded-lg">
  Join The Discussion
</button>
...
<button class="bg-[#5F5F5F] text-white font-semibold hover:text-white py-2 px-1 border border-blue-500 hover:border-transparent rounded-lg">
  Join The Discussion
</button>
